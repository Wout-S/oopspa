        ...
        function obj = buildingblock(data,kp,bprops)
            ...
            switch bprops.type
                ...
                case 'custom'
                    ...
                    ydir=bprops.orien;          % entered width direction
                    ...
                    for i=1:numel(bprops.eprops)
                        o=bprops.eprops(i).orien;
                        bprops.eprops(i).orien=o(1)*xdir+o(2)*ydir+o(3)*zdir; % correct orientation vectors of elements
                    end
